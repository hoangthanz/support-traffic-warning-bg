using Support.Warning.Traffic.BorderGuard.ViewModels.National;

namespace Support.Warning.Traffic.BorderGuard.Contracts;

public static class ConstApp
{
    public static List<Nation> Nations = new()
    {
        new Nation
        {
            Code = "af",
